...
$colItems = Get-WindowsFeature -ComputerName $Server.name | Select-Object displayName,installed,installState,postConfigurationNeeded | Where-Object {$_.PostConfigurationNeeded -eq $True}
