...
Get-ADGroup -filter * -SearchBase "OU=GroupID,OU=Offices,DC=<DOMAIN>,DC=Com" -properties name,mail,mailNickName | Select-Object name,mail,mailNickName | Export-Csv "c:\Temp\GroupID_SMTP_results.csv"
